...
class SportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post sports_url, params: { sport: { admin_id: @sport.admin_id, sport_name: @sport.sport_name } }
    end
  ...
  test "should update sport" do
    patch sport_url(@sport), params: { sport: { admin_id: @sport.admin_id, sport_name: @sport.sport_name } }
