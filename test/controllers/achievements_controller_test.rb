...
class AchievementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post achievements_url, params: { achievement: { award: @achievement.award, bronze_medal: @achievement.bronze_medal, gold_medal: @achievement.gold_medal, silver_medal: @achievement.silver_medal } }
    end
  ...
  test "should update achievement" do
    patch achievement_url(@achievement), params: { achievement: { award: @achievement.award, bronze_medal: @achievement.bronze_medal, gold_medal: @achievement.gold_medal, silver_medal: @achievement.silver_medal } }
